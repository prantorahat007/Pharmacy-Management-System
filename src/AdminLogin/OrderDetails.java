   ...
   //    DefaultTableModel table=(DefaultTableModel) ptable3.getModel();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         DefaultTableModel table=(DefaultTableModel) jTable1.getModel();
               try{
         int selt=jTable1.getSelectedRow();
         table.removeRow(selt);
         JOptionPane.showMessageDialog(rootPane, "Order delivered Successfully");
               }
               catch(Exception e){
                   JOptionPane.showMessageDialog(rootPane, "Pease Select a Product to deliver");
               }
